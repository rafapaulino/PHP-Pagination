...
//get indexes in page
$indexes = $pagination->getIndexes(new StrategyPHPBB(8,3));
            ...
            <div class="col-md-10">
                <nav aria-label="Page navigation">
                    <ul class="pagination">
                        ...
                        <?php while ($initial->valid()): ?>
                            <li>
                                <a href="?page=<?php echo $initial->current() ?>">
                                    <?php echo $initial->current() ?>
                                </a>
                            </li>
                        <?php $initial->next(); endwhile; ?>
                        <?php if($initial->count() > 0): ?>
                            <li><a>...</a></li>
                        <?php endif; ?>
                        ...
                        <?php if($final->count() > 0): ?>
                            <li><a>...</a></li>
                        <?php endif; ?>
                        <?php while ($final->valid()): ?>
                            <li>
                                <a href="?page=<?php echo $final->current() ?>">
                                    <?php echo $final->current() ?>
                                </a>
                            </li>
                        <?php $final->next(); endwhile; ?>
